...
/**
 * This is the UI of the <code>SpecialVendingMachine</code>
 */
public class SpecialVendingMachineUI {
    ...
    private JMenuItem openM, exitM, openV, exitV, openProducts;
    ...
    /**
     * This is the constructoe for the <code>SpecialVendingMachineUI</code>. It will show the components of the machine
     */
    public SpecialVendingMachineUI(){
        ...
        //Panel for inputs
        this.inputsPanel = new JPanel(new GridLayout(4, 1));
    ...
    /**
     * Sets the <code>actionListener</code> for the confirm button of add to cart
     * @param actn add to cart
     */
    ...
    /**
     * Sets the <code>actionListener</code> for the buy button
     * @param actn buys item in cart
     */
    ...
    /**
     * Sets the <code>actionListener</code> for the create and buy button
     * @param actn create and buys product
     */
    ...
    /**
     * Sets the <code>actionListener</code> for the cancel transaction button
     * @param actn remove items in cart and reset fields
     */
    ...
    /**
     * Sets the product field to its initial text
     */
    ...
    /**
     * Sets the items field to its inital text
     */
    ...
    /**
     * Sets the text of the cash field
     * @param text money
     */
    ...
    */
    ...
    /**
     * Sets the text of the process area
     * @param text proccessing text
     */
    ...
    /**
     * Sets the text in the receipt field
     * @param text receipt
     */
    ...
    /**
     * Sets the text in the cart area 
     * @param text Cart information
     */
    ...
    /**
     * Sets the text in the Items Field
     * @param text label
     */
    ...
    /**
     * Sets the <code>ActionListener</code> of the openM button
     * @param actn open maintenance
     */
    ...
    /**
     * Sets the <code>ActionListener</code> of the exitM button
     * @param actn exits maintenance
     */
    ...
    /**
     * Gets the text of the Items Field
     * @return label
     */
    ...
    /**
     * Gets the text of the product name field
     * @return product name
     */
